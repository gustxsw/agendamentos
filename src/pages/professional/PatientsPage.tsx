...
import { Users, UserPlus, Search, Phone, MapPin, Calendar, Edit, Trash2, X, Check, AlertCircle } from 'lucide-react';
      ...
      {filteredPatients.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPatients.map((patient) => (
            <div key={patient.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
              {/* Patient Header */}
              ...
              <div className="flex justify-between items-center mt-4 pt-4 border-t border-gray-100">
                ...
                <button
                  onClick={() => {
                    ...
                    console.log('View patient history:', patient.id);
                  }}
